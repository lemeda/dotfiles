...
mytextclock = wibox.widget.textclock(" %a %b %d, %H:%M ", 20);
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Print",
    function()
        awful.util.spawn("scrot -e 'mv $f /home/lena/lemeda/screenshots/'")
    end),

    -- Lock screen without suspending system
    awful.key({ modkey }, "l",
        function()
            awful.util.spawn("i3lock -u -i lemeda/Pictures/Wallpapers/Archlinux.png")
        end),
